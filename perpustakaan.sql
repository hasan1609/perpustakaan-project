...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2023 at 07:28 PM
...
INSERT INTO `absen` (`id`, `nama`, `jabatan`, `username`, `foto`, `status`, `created`) VALUES
(19, 'AchmadNugrahaDjuanda19', 'Admin', 'AchmadNugrahaDjuanda19', '642ad5f421495.png', 1, '2023-04-03 13:38:12');
...
(18, '555', '345345', '0', 'umi.jpg', '2023-04-05 07:00:40');
...
(2, '123', '1345', '2023-03-22', '2023-03-09', '2', '13500', 'Ade Tjakralaksana', 'YTGJB356GBH24', '2023-04-05 06:55:24'),
(3, '555', '345345', '2023-03-22', '2023-03-10', '2', '13000', 'Ade Tjakralaksana', 'YTGJB356GBH24', '2023-04-05 06:55:35'),
(4, '232', '232323', '2023-03-22', '2023-03-25', '2', '5500', 'Ade Tjakralaksana', 'YTGJB356GBH24', '2023-04-05 06:55:37'),
(5, '232', '232323', '2023-03-22', '2023-03-25', '2', '5500', 'Adhi Utomo', 'YTGJB356GBH26', '2023-04-05 06:55:39'),
(6, '232', '232323', '2023-03-22', '2023-03-08', '2', '14000', 'user', 'YTGJB356GBH24', '2023-04-05 06:55:40'),
(7, '123', '1345', '2023-03-26', '2023-03-29', '2', '3500', 'user', 'YTGJB356GBH24', '2023-04-05 06:55:41'),
(8, '555', '345345', '2023-03-01', '2023-03-08', '0', NULL, 'user', 'YTGJB356GBH24', '2023-04-05 08:25:52');
...
(1, 'YTGJB356GBH24', 1, '123', 'user', '122', '555', '2023-04-02 17:20:41');
...
CREATE TABLE `skbp_2` (
  ...
  `req_perpus` varchar(40) NOT NULL,
  `judul` text NOT NULL,
  `Abstrak_Toc` varchar(123) DEFAULT NULL,
  `Appedieces` varchar(123) DEFAULT NULL,
  `Chapter_1` varchar(123) DEFAULT NULL,
  `Chapter_2` varchar(123) DEFAULT NULL,
  `Chapter_3` varchar(123) DEFAULT NULL,
  `Chapter_4` varchar(123) DEFAULT NULL,
  `Conclusiuon` varchar(123) DEFAULT NULL,
  `Cover` varchar(123) DEFAULT NULL,
  `References` varchar(123) DEFAULT NULL,
  `status` int(4) NOT NULL,
  `created` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `skbp_2`
--

INSERT INTO `skbp_2` (`id`, `req_perpus`, `judul`, `Abstrak_Toc`, `Appedieces`, `Chapter_1`, `Chapter_2`, `Chapter_3`, `Chapter_4`, `Conclusiuon`, `Cover`, `References`, `status`, `created`) VALUES
(2, 'YTGJB356GBH24', 'fdffdg djhfgjdhgf fgjhfjdhg', 'abstrak_YTGJB356GBH23', 'appedieces_YTGJB356GBH23', 'chapter1_YTGJB356GBH23', 'chapter2_YTGJB356GBH23', 'chapter3_YTGJB356GBH23', 'chapter4_YTGJB356GBH23', 'conclusion_YTGJB356GBH23', 'cover_YTGJB356GBH23', NULL, 1, '2023-04-07 17:26:09');
