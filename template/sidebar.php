        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="permintaan">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/buttons.html">Peminjaman</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/dropdowns.html">Pengembalian</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Denda</a></li>
                ...
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Absensi Pengunjung</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html">Pengguna Baru</a></li>
